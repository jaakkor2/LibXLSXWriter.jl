...
using LibXLSXWriter: lxw_workbook_options, workbook_new_opt, workbook_add_worksheet, worksheet_write_string, worksheet_write_number, workbook_close, LXW_NO_ERROR
...
function main()
    ...
    options = lxw_workbook_options(output_buffer = output_buffer,
